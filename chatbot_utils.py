...
def chat_stream(messages, report_context="", data_context="", language="English"):
    ...
    - **Analysis Tab**: Shows metrics, sentiment trends, and category ratings. Allows generating a full AI report (PDF/DOCX/PPTX export).
    - **AI Assistant Tab**: You are here! This is where users interact with you.

    --- CONTEXT 2: GENERATED INTELLIGENCE REPORT ---
    (This is the high-level summary report generated by the system in the Analysis tab)
    ...
    2. PRIORITIZE the 'GENERATED INTELLIGENCE REPORT' for conclusions/summaries if available.
